...
function ENT:Draw()
    ...
    cam.Start3D2D(self.Pos, Angle(0, LocalPlayer():EyeAngles().y-90, 90), .15)
     draw.SimpleTextOutlined(priceText, "RighteousFont", -priceTextWidth * 0.5, -priceTextHeight * 0.5, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0, 0, 0))
     draw.SimpleTextOutlined("Poumon Sale", "RighteousFont2", -90, 25, Color(210, 69, 69), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0, 0, 0))
	 cam.End3D2D()
end
